...
<body>
        ...
        <div class="width repository_header clearfix">
            ...
            <nav class="navbar menu_mid fl">
                <ul>
                    ...
                    <li><a href="#" onclick="ChangeSrc('/ResourceManage/TextbookManager.aspx',this)">教材管理</a></li>
                </ul>
            </nav>
    ...
    <div class="onlinetest_item  pt90">
        <div class="myexam bordshadrad width" style="padding: 0px;">
            ...
            <div class="mycourse">
                <iframe src="/ResourceManage/SubjectManager.aspx" width="100%"  id="iframeContent" scrolling="no" allowtransparency="true" frameborder="no"></iframe>
            </div>
        </div>
    </div>
