            ...
            <div class="width clearfix testsystem_wrap  pt20">
                ...
                <div class="onlinetest_right fr bordshadrad pr">
                    ...
                    <div class="test_norelase">
                        <ul class="test_lists exam_lists" id="ul_Paper"><div style="background: url(/images/error.png) no-repeat center center; height: 500px;"></div></ul>                       
                    </div>
                    <!--分页-->
                    <div class="page">
...
<script type="text/javascript">
    ...
    function LookQuestion(id) {
        OpenIFrameWindow('预览试卷', '/ExamManage/ExamPaperDetail.aspx?id=' + id, '900px', '70%');
    }
    function ReleasePaper(Id, qtype, Name) {
        OpenIFrameWindow('发布试卷', '/ExamManage/ReleaseExam.aspx?Id=' + Id + '&name=' + Name + '&qtype=' + qtype, '780px', '70%');
    }
    function MakeExamPaper() {
        ...
        location.href = "/ExamManage/ManualChooseQ.aspx" + parm;
    }
</script>
