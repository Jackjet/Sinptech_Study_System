                    ...
                    <div class="testassem">
                        ...
                        <div class="autotest">
                            ...
                            <a href="javascript:;" onclick="MakeExamPaper()">
                                <input type="button" name="" class="btn" value="开始组卷" /></a>
...
<script type="text/javascript">
            ...
            success: function (json) {
                ...
                $.each(json.result.retData, function () {
                    html += "<div class=\"clearfix\">"
                                        ...
                                        + "<span onclick=\"addrandom('" + this.Name + "','" + FuncName + "',this)\">+</span>"
        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                $.each(json.result.retData, function () {
                    ...
                    html += "<div class=\"clearfix\">"
                                        + "<label for=\"\" >" + this.Name + "</label>"
                                        + "<span onclick=\"addrandom('" + this.Name + "','" + actionzhu + "',this)\">+</span>"
    ...
    //    }
    //}
    function addrandom(Title, action, em) {
        var arrray = [];
        var json = {};
        var id = 0;
        ...
        $.ajax({
            ...
            async: false,
            dataType: "json",
            data: { PageName: "/ExamManage/QuestionHander.ashx", "action": action, "QTypeName": Title },
            success: function (json) {
                var totalText = $('.test_number').find('#Number');
