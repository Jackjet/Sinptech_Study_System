<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionnaireSurvey .aspx.cs" Inherits="SSSWeb.ExamManage.QuestionnaireSurvey" %>
...
<script type="text/javascript">
    ...
    function GetQNumByTypeObj(idd) {
        $.ajax({
            ...
            data: {
                PageName: "/Exam/ExamHandler.ashx",
                "action": "GetQNumByTypePaperObj", "ID": idd
            },
            success: function (json) {
                if (json.result.errNum.toString() == "0") {
                    $.each(json.result.retData, function () {
                        ...
                        GetQDetailOfObj(this.Title, idd);
                        fhr += "</div>";
                        fhr += "</div>";
                        fhr += "</div>";
                        onclick += "</ul>";
    ...
    function GetQNumByTypeSub(idd) {
        $.ajax({
            ...
            data: {
                PageName: "/Exam/ExamHandler.ashx",
                "action": "GetQNumByTypePaperSub", "ID": idd
            },
            success: function (json) {
                if (json.result.errNum.toString() == "0") {
                    $.each(json.result.retData, function () {
                        ...
                        htmll += "<div class=\"paper_mes\">"
                            + "<div class=\"paper_numer\">"
                                ...
                                + "</h1>"
                                + "<div class=\"paper_number_mes\" style=\"display: block;\">";
                        GetQDetailOfSub(this.Title, idd);
                        htmll += "</div>";
                        htmll += "</div>";
                        htmll += "</div>";
    ...
    function GetQDetailOfObj(Title, idd) {
        ...
        $.ajax({
            ...
            data: {
                PageName: "/Exam/ExamHandler.ashx",
                "action": "GetQDetailOfPaperObj", "ID": idd, "Title": Title
            },
            success: function (json) {
    ...
    function GetQDetailOfSub(Title, idd) {
        $.ajax({
            ...
            data: {
                PageName: "/Exam/ExamHandler.ashx",
                "action": "GetQDetailOfPaperSub", "ID": idd, "Title": Title
            },
            success: function (json) {
