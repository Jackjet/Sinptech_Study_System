...
<script type="text/javascript">
    ...
    function AddQuestion() {
        ...
        if (HPeriod == "" || HSubject == "" || HTextboox == "" || bookVersion == "" || HChapterID == "") {
            ...
            OpenIFrameWindow('新增试题', '/ExamManage/AddQuestion.aspx' + parm, '800px', '70%');
        }
    }
    //修改试题
    function EditQuestion(Id, type, QType) {
        OpenIFrameWindow('编辑试题', '/ExamManage/EditQuestion.aspx?Id=' + Id + "&type=" + QType + "&TypeID=" + type, '830px', '70%');
    }
    //启用、禁用试题
    ...
    function LookQuestion(Id, Qtype) {
        OpenIFrameWindow('查看试题', '/ExamManage/LookQuestion.aspx?Id=' + Id + "&type=" + Qtype, '780px', '70%');
    }
    //删除试题
