                ...
                if (json.result.errNum.toString() == "0") {
                    ...
                    $.each(json.result.retData.PagedData, function () {
                        ...
                        if (relvalueid == 1 && ((Date.parse(this.WorkBeginTime) < Date.parse(myDate)) && (Date.parse(myDate) < Date.parse(this.WorkEndTime)))) {
                            if (this.typeid == 4) {
                                html += "<h2 style=\"width:200px\"><a onclick='window.open(\"/ExamManage/QuestionnaireSurvey .aspx?id=" + this.ID + "\");'>" + this.Title + "(可答)</a></h2>";
                            }
                            html += "<h2 style=\"width:200px\"><a onclick=\"window.open('/ExamManage/onlineanswer.aspx?id=" + this.ID + "');\">" + this.epname + "(可答)</a></h2>";
                        }
                        else {
                            html += "<h2 style=\"width:200px\"><a href='javacript:void(0);' style=\"color:gray;\">" + this.epname + "</a></h2>";
                        }
