...
<body>
    ...
    <header class="repository_header_wrap manage_header">
        <div class="width repository_header clearfix">
            <a class="logo fl" href="/PersonalSpace/PersonalSpace_Student.aspx">
            ...
            <nav class="navbar menu_mid fl" id="navlists">
                <ul>
                    <li class="active"><a href="/PersonalSpace/CourseManIndex.aspx">课程首页</a></li>
    ...
    <div id="courseManindex">
        ...
        <div style="background: #fff">
            <div class="width clearfix">
                ...
                <div class="courseindex_right bordshadrad fl" style="height: auto; margin-left: 28px;">
                    ...
                    <ul class="topcourse_list topcourse_lista">
                        ...
                        <li>
                            <a href="">
                                <p class="topcourse_list_name"><span>2</span>语言是一门艺术</p>
                                <div class="sort_detail clearfix">
                                    <div class="sort_detail_img fl">
                                        <img src="" alt="Alternate Text" />
                                    </div>
                        ...
                        <li>
                            <a href="">
                                <p class="topcourse_list_name"><span>3</span>语言是一门艺术</p>
                                <div class="sort_detail clearfix">
                                    <div class="sort_detail_img fl">
                                        <img src="" alt="Alternate Text" />
                                    </div>
                        ...
                        <li>
                            <a href="">
                                <p class="topcourse_list_name"><span>4</span>语言是一门艺术</p>
                                <div class="sort_detail clearfix">
                                    <div class="sort_detail_img fl">
                                        <img src="" alt="Alternate Text" />
                                    </div>
    ...
    <script>
        function SinUp(ID) {
            $.ajax({
                ...
                data: { "PageName": "CourseManage/CourceManage.ashx", Func: "SingUp", CourseID: ID, StuNo: '<%=UserInfo.UniqueNo%>' },
                dataType: "json",
                    ...
                    if (json.result.errNum.toString() == "0") {
                        if (json.result.retData != null && json.result.retData.length > 0) {
                            $(json.result.retData).each(function () {
                                ...
                                if (this.CourceType == "1" && $("#Catogary1").children().length < 4) {
                                    $("#Catogary1").append(li);
                                }
                                else if (this.CourceType == "2" && $("#Catogary2").children().length < 4) {
                                    $("#Catogary2").append(li);
                                }
                                else if (this.CourceType == "3" && $("#Catogary3").children().length < 4) {
                                    $("#Catogary3").append(li);
                                }
                            })
                        }
