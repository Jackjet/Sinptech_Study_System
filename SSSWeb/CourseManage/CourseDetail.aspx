...
<body>
        ...
        <header class="repository_header_wrap manage_header">
            <div class="width repository_header clearfix">
                ...
                <nav class="navbar menu_mid fl">
                    <ul id="Title1" style="display:none;">
    ...
    <script type="text/javascript">
        ...
        function addLeftMenu(id, pid, em, divid, Type) {
            ...
            if (length == 0) {
                var v = "<input type='text' value=''  maxlength='10' style='float:left;line-height:10px;margin-top:5px;width:100px;' id=\"Menu" + id +
...
")\"></i> <i class=\"icon icon-remove tishi fault_t\" style=\"margin: 0px 0px 0px 6px; color: #ff6d72; float: left;cursor:pointer;\" onclick=\"DelCurrentAddMenu(this)\"></i>";
        ...
        function EditMenu(em, id, name, e) {
            ...
            if (name == title) {
                var v = "<input type='text' value='" + title + "'  maxlength='10' style='float:left;line-height:10px;margin-top:5px;width:100px;' id=\"txt" + id +
                    ...
                    if (json.result.errNum.toString() == "0") {
                        ...
                        $(json.result.retData).each(function () {
                            var li = " <li><div class=\"course_detail_img\"><img src=\"" + this.VidoeImag + "\" onerror=\"javascript:this.src='/images/viedo_default.jpg'\"/></div><p class=\"course_detail_name\">" +
                               ...
                               + ",'" + this.Name + "','" + this.VidoeImag + "')\" style=\"position:absolute;right:20px;top:4px;width:16px;height:16px;color:#fff;\"></i><i class=\"icon icon-trash\" onclick=\"Delvideo(0," + this.ID
        ...
        function EditVideo(id, Name, Url) {
            OpenIFrameWindow("视频属性修改", "/CourseManage/EditWeike.aspx?ID=" + id + "&Name=" + encodeURI(Name) + "&Url=" + Url, "320px", "320px");
        }
        //删除微课资源
        ...
        function Adjust() {
            var CourceName = $("#CourceName").html();
            var CourceID = UrlDate.itemid

            OpenIFrameWindow('选课人员调整', '/CourseManage/CourceAdjust.aspx?CourceID=' + CourceID + "&CourceName=" + CourceName, '600px', '500px');
        }       
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.result.errNum.toString() == "0") {
                        ...
                        "任务：" + this.RelName + "( 权重：" + this.Weight + "&emsp;)</div>" + " <div class='clearfix mt5'><div class=\"clearfix fl caozuo_none\">"
