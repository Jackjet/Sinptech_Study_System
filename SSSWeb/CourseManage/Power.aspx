                ...
                <div class="right_dcon fr">
                    <div class="Operation_area">
                        ...
                        <div class="right_add fr">
                            ...
                            <a class="add" href="#" onclick="UserImport()">用户同步</a>
...
<script>
    ...
    function AddMemberByRoleid() {
        ...
        OpenIFrameWindow('成员设置', '/SystemSettings/MemberSettings.aspx?itemid=' + selnodes[0].id + "&SystemKey=" + $("#sel_system").val(), '620px', '610px');
    }
