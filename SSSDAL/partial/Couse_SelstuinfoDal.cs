    ...
    public partial class Couse_SelstuinfoDal : BaseDal<Couse_Selstuinfo>, ICouse_SelstuinfoDal
    {
        public override DataTable GetListByPage(Hashtable ht, out int RowCount, bool IsPage = true, string Where = "")
        {
            ...
            try
            {
                ...
                string operSymbol = "";
                sbSql4org.Append(@"select distinct co.*,sel.ID as SelId,sel.IsFinish,sel.StuNo,sel.LastStudyTime
                ...
                */
                ...
                if (ht.ContainsKey("StuNo") && !string.IsNullOrEmpty(ht["StuNo"].ToString()))
                {
                    sbSql4org.Append(@" left join System_Favorites fav on fav.RelationID=co.ID and fav.Creator=@StuNo and fav.Type=1
                                        left join Course_Evalue cevalue on co.ID=cevalue.CouseID and  cevalue.CreateUID=@StuNo");
                }
